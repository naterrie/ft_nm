...
run: all
	./$(NAME) -ra tests/libft.so .objs/32bits.o tests/cub3D tests/ft_nm tests/as tests/32bits.o > mine ; nm -ra tests/libft.so .objs/32bits.o tests/cub3D tests/ft_nm tests/as tests/32bits.o > true ; diff mine true
